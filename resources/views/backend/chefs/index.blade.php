    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          ...
          <a href="/chef-backend/create" class="btn btn-primary"><span data-feather="plus-circle">
          </span> Create Chef</a>
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row">{{$chefs->firstItem()+$loop->index}}</th>
                  <td style="width: 10px;">
                  ...
                  <td>
                    <a href="/chef-backend/{{ $data->id }}/edit" class="btn btn-warning btn-sm">
                        <span data-feather="edit"></span> Edit</a>
            
            <form action="chef-backend/{{ $data->id }}" method="post" class="d-inline">
                @method('DELETE')
                    @csrf
